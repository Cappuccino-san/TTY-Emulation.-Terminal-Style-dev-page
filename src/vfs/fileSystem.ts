...
AI/ML Workflow & Systems Engineer specializing in **Machine Learning**, **ML Model Deployment**, **Training Pipeline Development**, and **Data Engineering** with a deep foundation in **Large-Scale Systems**, **System Design**, and secure cloud architecture on **AWS**.

Proven expertise building **Compound AI workflows** (AWS Bedrock, LangGraph), **hybrid vector retrieval** (pgvector), and **low-latency inference runtimes** (vLLM, TensorRT-LLM) alongside **distributed Big Data lakehouses** (Databricks, PySpark, Delta Lake). Combines advanced computer vision (**PyTorch, SAM 2, OpenCV**) with an **M.S. in Security Studies** to execute deterministic workflows adhering to **NIST AI RMF**, **NIST CSF**, and strict engineering standards.

---

## Technical Skills Summary
- **Languages & Core**: Python, SQL, TypeScript, JavaScript, HTML, CSS, Node.js, Bash, Linux, Java, C++, C#, Rust, MATLAB/Simulink, Perl, Data Structures & Algorithms, Statistics.
...
• AI/ML & GenAI: PyTorch, AWS Bedrock, LangGraph, LlamaIndex, vLLM, TensorRT-LLM,
  PEFT (LoRA, QLoRA), pgvector, Qdrant, MLflow, Weights & Biases, OpenCV,
  Segment Anything 2 (SAM 2), MediaPipe, InsightFace, IPAdapter, ComfyUI,
...
**Winthrop, MA** | **(857) 205-3266** | **[njnapoli99@gmail.com](mailto:njnapoli99@gmail.com)** | [LinkedIn](https://linkedin.com/in/nicholas-napoli476) | [GitHub](https://github.com/cappuccino-san)
...
### **Aesthetic360** — AI/ML Workflow Engineer *(Boston, MA | Nov 2025 – Present)*
- **Compound GenAI Workflows**: Led software application development and training pipelines for end-to-end GenAI workflows using **AWS Bedrock**, **LangGraph**, and **Stability AI**, establishing deterministic fallback logic, tool calling, and self-correction loops.
- **Low-Latency Inference & Vector Retrieval**: Implemented high-throughput, low-latency model inference using **vLLM** and quantized open-weight architectures, integrating **pgvector** hybrid semantic search and prompt caching for clinical workflows.
- **Synthetic Aging & Fine-Tuning**: Engineered the A360 synthetic aging pipeline via **ComfyUI**, **IPAdapter FaceID**, and parameter-efficient fine-tuning (**LoRA/QLoRA**), utilizing advanced algorithms to generate identity-preserving clinical data across age cohorts (20–70).
- **Distributed Big Data Lakehouses**: Architected distributed lakehouse data pipelines leveraging Big Data technologies (**PySpark**, **Databricks**, **Delta Lake**, **AWS Glue**) to process, clean, and transform 10,000+ multimodal patient records with strict ACID transactional guarantees.
- **MLOps & Automated Retraining**: Standardized model lifecycle tracking via **MLflow**; automated DAG task scheduling and retraining pipelines using **Apache Airflow** and **GitHub Actions CI/CD** for continuous, zero-downtime deployment.
- **Optics & 3D Computer Vision**: Built deterministic vision validation and optics-aligned feature extraction pipelines using **PyTorch**, **OpenCV**, **Segment Anything 2 (SAM 2)**, and **MediaPipe** for landmark boundary tracking and 3D LiDAR point cloud registration (**Open3D**).
- **Cloud Security Hardening**: Hardened AWS cloud infrastructure with IAM least-privilege policies, KMS envelope encryption, and S3 controls aligned to **NIST AI RMF**, **NIST CSF**, and aerospace-grade engineering standards.
- **AI Red Teaming & Privacy**: Conducted AI red teaming and security auditing adhering to **OWASP Top 10 for LLMs**; implemented **Guardrails AI** and **Microsoft Presidio** for automated PHI/PII sanitization across full-stack FastAPI and React applications.
...
export const SKILLS_JSON = `{
  ...
  "certifications": [
    "AWS Certified AI Practitioner (AIF-C01) [Issued Mar 2026]"
  ],
  "technical_skills": {
    "languages_and_core": [
...
**Tech**: PyTorch, AWS Bedrock, LangGraph, Stability AI, vLLM, TensorRT-LLM, LoRA/QLoRA, pgvector, ComfyUI, IPAdapter, PySpark, Databricks, Delta Lake, AWS Glue, Apache Airflow, MLflow, OpenCV, SAM 2, MediaPipe, Open3D, Docker, SageMaker, FastAPI, React, PostgreSQL, NIST AI RMF, OWASP Top 10 for LLMs, Guardrails AI, Presidio

- **Compound GenAI Workflows**: Led software application development and training pipelines for end-to-end GenAI workflows using AWS Bedrock, LangGraph, and Stability AI, establishing deterministic fallback logic, tool calling, and self-correction loops.
- **Low-Latency Inference**: Implemented high-throughput, low-latency model inference using vLLM and quantized open-weight architectures, integrating pgvector hybrid semantic search and prompt caching for clinical workflows.
- **Synthetic Aging Pipeline**: Engineered the A360 synthetic aging pipeline via ComfyUI, IPAdapter FaceID, and parameter-efficient fine-tuning (LoRA/QLoRA), utilizing advanced algorithms to generate identity-preserving clinical data across age cohorts (20–70).
- **Distributed Big Data Lakehouse**: Architected distributed lakehouse data pipelines leveraging Big Data technologies (PySpark, Databricks, Delta Lake, AWS Glue) to process, clean, and transform 10,000+ multimodal patient records with strict ACID transactional guarantees.
- **MLOps & Pipeline Automation**: Standardized model lifecycle tracking via MLflow; automated DAG task scheduling and retraining pipelines using Apache Airflow and GitHub Actions CI/CD for continuous, zero-downtime deployment.
- **Computer Vision & 3D Point Clouds**: Built deterministic vision validation and optics-aligned feature extraction pipelines using PyTorch, OpenCV, Segment Anything 2 (SAM 2), and MediaPipe for landmark boundary tracking and 3D LiDAR point cloud registration (Open3D).
- **Cloud Infrastructure Security**: Hardened AWS cloud infrastructure with IAM least-privilege policies, KMS envelope encryption, and S3 controls aligned to NIST AI RMF, NIST CSF, and aerospace-grade engineering standards.
- **AI Red Teaming & Privacy**: Conducted AI red teaming and security auditing adhering to OWASP Top 10 for LLMs; implemented Guardrails AI and Microsoft Presidio for automated PHI/PII sanitization across full-stack FastAPI and React applications.
...
- **GPA**: **3.90**
- **Specialization**: Cybersecurity Systems, Threat Modeling, NIST AI RMF, NIST CSF, Secure Cloud Architecture
