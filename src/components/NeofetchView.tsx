...
export const NeofetchView: React.FC<NeofetchViewProps> = ({ themeConfig, onCommandClick }) => {
  const infoItems = [
    ...
    { label: 'Location', value: 'Winthrop, MA' },
    { label: 'Certifications', value: 'AWS Certified AI Practitioner (AIF-C01) | Amazon Web Services | Issued Mar 2026' },
    { label: 'Education', value: 'M.S. Security Studies (GPA: 3.90) | B.S. (Cum Laude, GPA: 3.50)' },
    { label: 'Languages', value: 'Fluent in English and Italian, Python, SQL, TypeScript, Bash, C++, Rust' },
    { label: 'AI/ML & GenAI', value: 'PyTorch, AWS Bedrock, LangGraph, LlamaIndex, vLLM, TensorRT-LLM, SAM 2, pgvector' },
    { label: 'Big Data & Cloud', value: 'AWS (SageMaker, S3, KMS, IAM, Glue), Jupyter Notebook, Databricks, PySpark, Delta Lake' },
    { label: 'Security & Ops', value: 'NIST AI RMF, NIST CSF, ISO/IEC 42001, OWASP Top 10 for LLMs, Guardrails AI, Presidio' },
    { label: 'Contact', value: 'njnapoli99@gmail.com | (857) 205-3266' },
    { label: 'Website', value: 'https://napnet.click/' },
