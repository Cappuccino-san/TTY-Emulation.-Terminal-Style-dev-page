...
export const NeofetchView: React.FC<NeofetchViewProps> = ({ themeConfig, onCommandClick }) => {
  const infoItems = [
    ...
    { label: 'Certifications', value: 'AWS Certified AI Practitioner (AIF-C01) | Amazon Web Services | Issued 2026' },
    ...
    { label: 'Big Data & Cloud', value: 'AWS (SageMaker, S3, KMS, IAM, Glue), Databricks, PySpark, Delta Lake, Airflow' },
